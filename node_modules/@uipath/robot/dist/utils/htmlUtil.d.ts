import { Resource } from '../locale/resources/iResource';
/**
...
export declare class HtmlUtil {
     ...
     * @param portNumber Port number of the listener running on machine. Needed to load help images.
     */
    static showConsentOverlay: (consentCode: number, portNumber: number) => void;
    /**
     * Hides overlay
     */
    static hideConsentOverlay: () => void;
    /**
    * Show error overlay
    */
    static showErrorOverlay: () => void;
    private static cssToBind;
    private static consentHelpTemplate;
     ...
     */
    private static buildConsentHelpHtml;
    /**
     ...
     */
    private static generatePageURL;
    /**
     * Creates a blob URL
